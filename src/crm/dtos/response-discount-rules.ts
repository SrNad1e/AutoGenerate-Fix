...
@ObjectType({ description: 'Respuesta del listado de reglas de descuento' })
export class ResponseDiscountRules {
	@Field(() => [DiscountRule], { description: 'Lista de reglas de descuento' })
	docs: DiscountRule[];
